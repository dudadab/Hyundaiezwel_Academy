package designpattern.e_game.item.code;

import designpattern.e_game.item.Equipment;
import designpattern.e_game.item.Slot;
...
public enum EquipmentData {
    ...
    KATANA("카타나", 25, 1, Slot.WEAPON, "쉭쉭"),
    CLAYMORE("양손검", 40, 5, Slot.WEAPON, "부웅"),

    WOOD_ARMOR("나무갑옷", 1, 10, Slot.ARMOR, ""),
    WOOD_BOOTS("나무부츠", 1, 5, Slot.ARMOR, ""),
    PLATE_ARMOR("판금갑옷", 1, 25, Slot.ARMOR, "");
