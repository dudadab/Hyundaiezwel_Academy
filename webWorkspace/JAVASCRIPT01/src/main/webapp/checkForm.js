/**
 *  join.html 파일의 입력 유효성 검사를 지행하는 자바스크립트 코드
...
window.onload = function(){
	...
	document.getElementById('joinForm').onsubmit = function(){
		...
		//그룹내 라디오버튼 검사했는데 chk 가 false 그룹 내 어떤 라디오 버튼도 선택되지 않았음
		if(chk==false){
