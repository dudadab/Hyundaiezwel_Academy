...
- ROLE
    ...
    - EX. 일반 사용자의 필수 권한
        ...
        - 공통으로 필요한 권한을 ROLE로 그룹화 한 후
        - ROLE을 부여함
        - CONNECT, RESOURCE 등을 부여함
        
-- CONNECT 롤 : ALTER SESSION, CREATE와 관련된 롤
-- RESOURCE 롤 : 사용자 객체 생성 및 접근 권한에 해당되는 롤
...
-- 사용자 계정 생성
-- CREATE USER 계정명 IDENTFIED BY "비밀번호"
...
REVOKE CONNECT FROM NEWUSER2; -- DB접속과 관련된 ROLE 제거했으므로 접속 제한
...
-- DAB_USERS / ALL_USERS / USERS_USERS
