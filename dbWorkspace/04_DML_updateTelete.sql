...
UPDATE PRODUCT7 SET PRDNAME = 'UHD TV' WHERE PRDNO = '5';
...
-- DELETE FROM PRODUCT7; -- 테이블의 모든 행 삭제
-- 상품명이 그늘막 텐트인 행 삭제
DELETE FROM PRODUCT7 WHERE PRDNAME = '그늘막 텐트';

-- DELETE문의 반환 결과는 몇개 행이 삭제 되었는지에 대한 결과가 반환
